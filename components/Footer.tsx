  ...
  return (
    <footer className="bg-black border-t border-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 xl:gap-12">
          ...
          <div>
            ...
            <div className="space-y-2.5 mb-5">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-[15px] leading-6">Siruvani Main Road, GH Hospital (opposite), High School Bus Stop, Post Pooluvapatti, Coimbatore-641101</span>
              </div>
              <div className="flex items-start space-x-3">
                <Phone className="w-5 h-5 text-[#639922] shrink-0 mt-0.5" />
                <div className="flex flex-col space-y-1">
                  <a href="tel:+918760285985" className="text-gray-400 hover:text-[#639922] transition-colors text-[15px]">+91 87602 85985</a>
                  <a href="tel:+917397285985" className="text-gray-400 hover:text-[#639922] transition-colors text-[15px]">+91 73972 85985</a>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Mail className="w-5 h-5 text-[#639922] shrink-0 mt-0.5" />
                <a href="mailto:supersolarfenc@gmail.com" className="text-gray-400 hover:text-[#639922] transition-colors text-[15px]">supersolarfenc@gmail.com</a>
              </div>
            </div>
            {/* Social Icons */}
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1ExVB36hD3/" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
              ...
              <a href="https://www.instagram.com/supersolarfencing_8760285985?igsh=cHczazRuNGt6Y2s4" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
              ...
              <a href="https://www.youtube.com/@supersolarfencing150" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
              ...
              <a href="https://wa.me/8760285985" target="_" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full border border-gray-800 flex items-center justify-center text-[#639922] hover:bg-[#639922] hover:text-white transition-all group">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><Link href="/services" className="text-gray-400 hover:text-[#639922] transition-colors text-[15px]">Services</Link></li>
          ...
          <div className="overflow-hidden">
            ...
            <ul className="space-y-2.5">
              <li><Link href="/products" title="Solar fencing materials" className="block truncate text-gray-400 hover:text-[#639922] transition-colors text-[15px]">Solar fencing materials</Link></li>
              <li><Link href="/products" title="Solar Panel (Mono & Polycrystalline)" className="block truncate text-gray-400 hover:text-[#639922] transition-colors text-[15px]">Solar Panel (Mono & Polycrystalline)</Link></li>
              <li><Link href="/products" title="GI wire" className="block truncate text-gray-400 hover:text-[#639922] transition-colors text-[15px]">GI wire</Link></li>
              <li><Link href="/products" title="Auto Cut Battery Charger 10A" className="block truncate text-gray-400 hover:text-[#639922] transition-colors text-[15px]">Auto Cut Battery Charger 10A</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <Link href="https://maps.app.goo.gl/ZSdT2SQwv4oPqi8A8?g_st=aw" target="_blank" rel="noopener noreferrer" className="block w-full h-[180px] bg-gray-200 rounded-lg overflow-hidden relative group">
              <iframe 
              ...
              <div className="absolute inset-0 bg-black/10 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                <span className="bg-black/80 text-white text-xs font-bold px-3 py-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">Open in Maps</span>
              </div>
            </Link>
          </div>
      ...
      <div className="border-t border-gray-800 bg-black">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col md:flex-row justify-center md:justify-between items-center text-center md:text-left text-[14px] sm:text-[15px] text-gray-400">
          <p>&copy; {new Date().getFullYear()} supersolarfence.com, All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
