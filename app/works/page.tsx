...
import Image from "next/image"; // Note: For placeholder, we'll use a stylized div rather than an actual next/image if no image exists, but we'll build the layout
      ...
      <SectionWrapper>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Take a look at some of our successful installations securing perimeters across agricultural lands, industrial complexes, and residential estates.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectData.map((project) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-100/50 to-slate-200/50 flex flex-col items-center justify-center text-slate-400 group-hover:scale-105 transition-transform duration-700">
                 <span className="text-5xl mb-2 opacity-50">🏗️</span>
                 <span className="font-mono text-sm tracking-widest uppercase opacity-50">{project.category}</span>
              </div>
